...
class TestSquare_height(unittest.TestCase):
    """Unittests for testing initialization of Square height attribute."""
...
class TestSquare_x(unittest.TestCase):
    ...
    def test_memoryview_x(self):
        with self.assertRaisesRegex(TypeError, "x must be an integer"):
            Square(1, 2, memoryview(b'abcedfg'))
...
class TestSquare_y(unittest.TestCase):
    ...
    def test_frozenset_y(self):
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
            Square(1, 2, 3, frozenset({1, 2, 3, 1}))

    def test_range_y(self):
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
            Square(1, 2, 3, range(5))

    def test_bytes_y(self):
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
            Square(1, 2, 3, b'Python')

    def test_bytearray_y(self):
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
            Square(1, 2, 3, bytearray(b'abcdefg'))

    def test_memoryview_y(self):
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
            Square(1, 2, 3, memoryview(b'abcedfg'))
...
class TestSquare_order_of_initialization(unittest.TestCase):
    ...
    def test_height_before_x(self):
        with self.assertRaisesRegex(TypeError, "height must be an integer"):
            Square(1, "invalid height", "invalid x")

    def test_height_before_y(self):
        with self.assertRaisesRegex(TypeError, "height must be an integer"):
            Square(1, "invalid height", 2, "invalid y")
...
class TestSquare_area(unittest.TestCase):
    ...
    def test_area_large(self):
        r = Square(999999999999999, 999999999999999999, 0, 0, 1)
...
class TestSquare_stdout(unittest.TestCase):
    ...
    def test_str_method_size_height_x(self):
        r = Square(5, 5, 1)
        correct = "[Square] ({}) 1/0 - 5/5".format(r.id)
    ...
    def test_str_method_size_height_x_y_id(self):
        r = Square(13, 21, 2, 4, 7)
        self.assertEqual("[Square] (7) 2/4 - 13/21", str(r))
    ...
    def test_str_method_changed_attributes(self):
        ...
        r.x = 8
        r.y = 10
        self.assertEqual("[Square] ([4]) 8/10 - 15/1", str(r))
...
class TestSquare_update_args(unittest.TestCase):
    ...
    def test_update_args_one(self):
        r = Square(10, 10, 10, 10, 10)
        r.update(89)
        self.assertEqual("[Square] (89) 10/10 - 10/10", str(r))

    def test_update_args_two(self):
        r = Square(10, 10, 10, 10, 10)
        r.update(89, 2)
        self.assertEqual("[Square] (89) 10/10 - 2/10", str(r))

    def test_update_args_three(self):
        r = Square(10, 10, 10, 10, 10)
        r.update(89, 2, 3)
        self.assertEqual("[Square] (89) 10/10 - 2/3", str(r))

    def test_update_args_four(self):
        r = Square(10, 10, 10, 10, 10)
        r.update(89, 2, 3, 4)
        self.assertEqual("[Square] (89) 4/10 - 2/3", str(r))

    def test_update_args_five(self):
        r = Square(10, 10, 10, 10, 10)
        r.update(89, 2, 3, 4, 5)
        self.assertEqual("[Square] (89) 4/5 - 2/3", str(r))
    ...
    def test_update_args_None_id_and_more(self):
        r = Square(10, 10, 10, 10, 10)
        r.update(None, 4, 5, 2)
        correct = "[Square] ({}) 2/10 - 4/5".format(r.id)
        self.assertEqual(correct, str(r))
...
class TestSquare_update_kwargs(unittest.TestCase):
    ...
    def test_update_kwargs_one(self):
        r = Square(10, 10, 10, 10, 10)
        r.update(id=1)
        self.assertEqual("[Square] (1) 10/10 - 10/10", str(r))

    def test_update_kwargs_two(self):
        r = Square(10, 10, 10, 10, 10)
        r.update(size=2, id=1)
        self.assertEqual("[Square] (1) 10/10 - 2/10", str(r))
    ...
    def test_update_kwargs_four(self):
        r = Square(10, 10, 10, 10, 10)
        r.update(id=89, x=1, height=2, y=3, size=4)
        self.assertEqual("[Square] (89) 1/3 - 4/2", str(r))

    def test_update_kwargs_five(self):
        r = Square(10, 10, 10, 10, 10)
        r.update(y=5, x=8, id=99, size=1, height=2)
        self.assertEqual("[Square] (99) 8/5 - 1/2", str(r))
    ...
    def test_update_kwargs_None_id_and_more(self):
        ...
        correct = "[Square] ({}) 10/9 - 10/7".format(r.id)
        self.assertEqual(correct, str(r))
    ...
    def test_update_kwargs_twice(self):
        ...
        self.assertEqual("[Square] (89) 1/3 - 2/15", str(r))
    ...
    def test_update_kwargs_some_wrong_keys(self):
        ...
        self.assertEqual("[Square] (89) 19/7 - 10/5", str(r))
...
class TestSquare_to_dictionary(unittest.TestCase):
    ...
    def test_to_dictionary_output(self):
        r = Square(10, 2, 1, 9, 5)
        correct = {'x': 1, 'y': 9, 'id': 5, 'height': 2, 'size': 10}
